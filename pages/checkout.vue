    ...
    <MainLayout>
        <div id="CheckoutPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                <div class="md:w-[65%]">
                    <div class="bg-whtite rounded-lg p-4">
                        <div class="text-xl font-semibold mb-2">ที่อยู่จัดส่ง</div>

                        <div v-if="currentAddress && currentAddress.data">
                            <NuxtLink to="/address" class="items-center pb-2 text-blue-500 hover:text-red-200">
                                <Icon name="mdi:plus" size="18" class="mr2" />
                                อัพเดตที่อยู่
                            </NuxtLink>
                ...
                <div class="md:w-[35%]">
                    <div id="PlaceOrder" class="bg-white rounded-lg p-4">
                        ...
                        <div class="text-2xl font-extrabold mb-2">ชำระเงิน</div>

                        <div class="flex items-center justify-between my-4">
                            <div class="">สินค้าทั้งหมด</div>
                        ...
                        <div class="flex items-center justify-between my-4">
                            ...
                            <div class="text-2xl font-semibold">
                                <span class="font-extrabold">{{ total }} บาท</span>
                            </div>
                        </div>
